...
a prompt fits within the model limits and to estimate the cost of a call. Since
using these models can get expensive[^2], let’s see how we can get the most out
of an API call.
...
* `finish_reason`: This shows why the processing finished. If all went well, the
  ...
  the content and abort processing.
